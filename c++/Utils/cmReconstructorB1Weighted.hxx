#ifndef __cmReconstructorB1Weighted_hxx
#define __cmReconstructorB1Weighted_hxx
...
void ReconstructorB1Weighted< VectorImageType,ScalarImageType>
...
//				/* prepare */
				...
				/* BANG!!*/
								while( !iif.IsAtEnd() )
								{
									...
									io.Set((ScalarImagePixelType)std::abs(OV(0,0)));
									++is;
									++iif;
									++io;
								}
