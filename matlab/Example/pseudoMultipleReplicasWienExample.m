...
F=cm2DSignalToNoiseRatioPseudoMultipleReplicasWien();
F.setNumberOfPseudoReplicas(1)
F.setReconstructor(RE)
F.setSignalKSpace(KS)
F.setNoiseKSpace(KN);
F.setBoxSize(15)
figure();
imshow(abs(F.getOutput()),[]);
colorbar();
title('SNR RSS 2 replicas')
